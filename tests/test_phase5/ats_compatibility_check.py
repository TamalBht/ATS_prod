"""
ats_compatibility_check.py

Phase 6 Example Execution - ATS Compatibility & Formatting Analysis
Demonstrates complete ATS compatibility analysis on a sample PDF resume.

Usage:
    python ats_compatibility_check.py
    python ats_compatibility_check.py --resume path/to/resume.pdf
    python ats_compatibility_check.py --resume my_resume.pdf --role backend_engineer
    python ats_compatibility_check.py --detailed
"""
...
class ATSCompatibilityDemo:
    ...
    def run_complete_analysis(self, resume_path: str, role_name: str = None, detailed: bool = False):
        ...
        try:
            ...
            print(f"  Sections found: {', '.join([k for k in parsed_resume.keys() if k != 'raw_text'])}")
...
Examples:
  python ats_compatibility_check.py
  python ats_compatibility_check.py --resume data/sample_resumes/sample_resume.pdf
  python ats_compatibility_check.py --resume my_resume.pdf --role backend_engineer
